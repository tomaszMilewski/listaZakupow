...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QGridLayout, QVBoxLayout, QScrollArea, QLineEdit, QTabWidget, \
    QMainWindow, QPushButton, QMainWindow, QTabWidget
